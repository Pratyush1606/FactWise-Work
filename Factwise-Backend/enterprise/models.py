...
class UserAuth(AbstractUser):
    ...
    user_id = models.ForeignKey(User, related_name="User_auth_user_id", on_delete=models.CASCADE, null=True)
...
class UserEntity(models.Model):
    user_entity_relationship_id = models.AutoField(primary_key=True, editable=False) 
...
class UserPermission(models.Model):
    user_entity_relationship_id = models.ForeignKey(UserEntity, on_delete=models.CASCADE)
    action_api_group = models.CharField(max_length=100)
    criteria = models.CharField(max_length=100, blank=True)

    def get_user_id(self):
        user_entity = self.user_entity_relationship_id
        return user_entity.user_id_id
    
    def get_entity_id(self):
        user_entity = self.user_entity_relationship_id
        return user_entity.entity_id_id
