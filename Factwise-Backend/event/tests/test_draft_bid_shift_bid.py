...
class DraftBidShiftBidViewTest(APITestCase):
    def setUp(self):
        '''
        Populating test db 
        '''
    ...
    def test_post_valid_draft_bid_shift_bid(self):
        '''
        Shifting draft_bid with ID 1
        '''
        response = self.client.post(reverse("event:draft_bid_shift_bid" , args=[1]))
    ...
    def test_post_invalid_draft_bid_shift_bid(self):
        '''
        Shifting draft_bid with ID 2, which does not exist
        '''
        response = self.client.post(reverse("event:draft_bid_shift_bid" , args=[2]))
